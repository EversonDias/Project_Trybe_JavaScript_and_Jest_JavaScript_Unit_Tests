...
const arrayGenerator = (type, object) => {
  let arrayGenerated;
  if (type === 'keys') {
    arrayGenerated = Object.keys(object);
  } else if (type === 'values') {
    arrayGenerated = Object.values(object);
  } else if (type === 'entries') {
    arrayGenerated = Object.entries(object);
  } else {
    arrayGenerated = 'type não encontrado escolha keys, values ou entries';
  }
